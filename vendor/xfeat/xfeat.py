# Vendored from verlab/accelerated_features.
# Original license: see vendor/xfeat/LICENSE.
# Modified in this repository:
# - converted upstream imports to package-relative imports
# - changed default weight loading paths to use vendor/xfeat/weights/
...
class XFeat(nn.Module):
	...
	def __init__(self, weights = os.path.join(os.path.dirname(__file__), 'weights', 'xfeat.pt'), top_k = 4096, detection_threshold=0.05):
		super().__init__()
